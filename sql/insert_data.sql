-- Active: 1780921116213@@127.0.0.1@3306@cms
...
INSERT INTO patient (address, date_of_birth, email, name, password, phone) VALUES
('101 Oak St, Cityville', '1990-01-01', 'jane.doe@example.com', 'Jane Doe', 'passJane1', '888-111-1111'),
('202 Maple Rd, Townsville', '1985-02-02', 'john.smith@example.com', 'John Smith', 'smithSecure', '888-222-2222'),
('303 Pine Ave, Villageton', '1992-03-03', 'emily.rose@example.com', 'Emily Rose', 'emilyPass99', '888-333-3333'),
('404 Birch Ln, Metropolis', '1988-04-04', 'michael.j@example.com', 'Michael Jordan', 'airmj23', '888-444-4444'),
('505 Cedar Blvd, Springfield', '1995-05-05', 'olivia.m@example.com', 'Olivia Moon', 'moonshine12', '888-555-5555'),
('606 Spruce Ct, Gotham', '1993-06-06', 'liam.k@example.com', 'Liam King', 'king321', '888-666-6666'),
('707 Aspen Dr, Riverdale', '1991-07-07', 'sophia.l@example.com', 'Sophia Lane', 'sophieLane', '888-777-7777'),
('808 Elm St, Newtown', '1987-08-08', 'noah.b@example.com', 'Noah Brooks', 'noahBest!', '888-888-8888'),
('909 Willow Way, Star City', '1996-09-09', 'ava.d@example.com', 'Ava Daniels', 'avaSecure8', '888-999-9999'),
('111 Chestnut Pl, Midvale', '1983-10-10', 'william.h@example.com', 'William Harris', 'willH2025', '888-000-0000'),
('112 Redwood St, Fairview', '1994-11-11', 'mia.g@example.com', 'Mia Green', 'miagreen1', '889-111-1111'),
('113 Cypress Rd, Edgewater', '1989-12-12', 'james.b@example.com', 'James Brown', 'jamiebrown', '889-222-2222'),
('114 Poplar Ave, Crestwood', '1997-01-13', 'amelia.c@example.com', 'Amelia Clark', 'ameliacool', '889-333-3333'),
('115 Sequoia Dr, Elmwood', '1986-02-14', 'ben.j@example.com', 'Ben Johnson', 'bennyJ', '889-444-4444'),
('116 Palm Blvd, Harborview', '1998-03-15', 'ella.m@example.com', 'Ella Monroe', 'ellam123', '889-555-5555'),
('117 Cottonwood Ct, Laketown', '1990-04-16', 'lucas.t@example.com', 'Lucas Turner', 'lucasTurn', '889-666-6666'),
('118 Sycamore Ln, Hilltop', '1992-05-17', 'grace.s@example.com', 'Grace Scott', 'graceful', '889-777-7777'),
('119 Magnolia Pl, Brookside', '1984-06-18', 'ethan.h@example.com', 'Ethan Hill', 'hill2025', '889-888-8888'),
('120 Fir St, Woodland', '1993-07-19', 'ruby.w@example.com', 'Ruby Ward', 'rubypass', '889-999-9999'),
('121 Beech Way, Lakeside', '1991-08-20', 'jack.b@example.com', 'Jack Baker', 'bakerjack', '889-000-0000'),
('122 Alder Ave, Pinehill', '1995-09-21', 'mia.h@example.com', 'Mia Hall', 'hallMia', '890-111-1111'),
('123 Hawthorn Blvd, Meadowbrook', '1987-10-22', 'owen.t@example.com', 'Owen Thomas', 'owen123', '890-222-2222'),
('124 Dogwood Dr, Summit', '1996-11-23', 'ivy.j@example.com', 'Ivy Jackson', 'ivyIvy', '890-333-3333'),
('125 Juniper Ct, Greenwood', '1989-12-24', 'leo.m@example.com', 'Leo Martin', 'leopass', '890-444-4444'),
('126 Olive Rd, Ashville', '1994-01-25', 'ella.moore@example.com', 'Ella Moore', 'ellamoore', '890-555-5555');
